...
class OpenRouterClient(BaseLLMClient):
    """
    Client adapter for OpenRouter API.
    ...
    def _get_headers(self) -> Dict[str, str]:
        return {
            ...
            "HTTP-Referer": "https://unlocked.ai",
            "X-Title": "Unlocked AI",
    ...
    async def generate(
        ...
        **kwargs: Any
        ...
        model_name = model or settings.default_openrouter_model
        payload = {
            "model": model_name,
                    ...
                    if line.startswith("data: "):
                        ...
                        if "tool_calls" in delta and delta["tool_calls"]:
                            ...
                            for tc in delta["tool_calls"]:
                                # Stream tool calls may be missing 'id' or 'function' in subsequent chunks,
                                # client needs to handle assembly, but we route raw delta chunks here.
